...
import FPO.Data.JSON (decodeDocument, decodeGroup, decodeUser, encodeGroupCreate)
...
getDocuments :: Aff (Maybe (Array Store.Document))
getDocuments = getFromJSONEndpoint (decodeArray decodeDocument) "/groups/1/documents"
